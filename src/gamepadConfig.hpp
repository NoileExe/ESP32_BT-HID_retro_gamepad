...
// ИМЯ и ПРОИЗВОДИТЕЛЬ BT-УСТРОЙСТВА
inline constexpr std::string_view GAMEPAD_NAME = "My Gamepad 001";
inline constexpr std::string_view GAMEPAD_MANUFACTURER = "NoileExe";
...
inline constexpr std::string_view SOFTWARE_REVISION = "0.1.0";	// Версия прошивки
inline constexpr std::string_view HARDWARE_REVISION = "1.0";	// Ревизия платы/железа/конфигурации
...
// === Общие настройки ===
inline constexpr TypeMS REPORT_INTERVAL_MS = 10;						//Задержка в мс
