...
inline constexpr std::string_view SOFTWARE_REVISION = "0.2.0";	// Версия прошивки
...
inline constexpr TypeMS BATTERY_INTERVAL_MS = 10ul * 1000;				// Интервал проверки заряда аккумулятора в МС				
